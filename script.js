...
document.getElementById("title"+h3Count).addEventListener("keyup",function(){
    ...
    bottomElement.innerHTML = "&lt;h3 style='color: #000000; font-size: 18px; text-transform: none; font-weight: bold;'&gt;" + title.value + "&lt;/h3&gt;" + "&lt;p style='padding: 1px; max-width:80%;'&gt;" + content.value.replace(/\n/g, "") + "&lt;/p&gt;";
